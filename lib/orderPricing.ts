...
// TaxBreakDown field names/order) — different Firebase project, just a consistent vocabulary.
...
export function calculateTaxBreakdown(subTotal: number): TaxBreakDown {
